...
from cosypose.bop_config import SYNPICK_REAL_COARSE, SYNPICK_REAL_REFINER, SYNPICK_REAL_DETECTORS
...
def main():
    ...
    if args.config == 'synpick':
        MODELS_DETECTORS = SYNPICK_REAL_DETECTORS
        MODELS_COARSE = SYNPICK_REAL_COARSE
        MODELS_REFINER = SYNPICK_REAL_REFINER
    else:
        raise ValueError
